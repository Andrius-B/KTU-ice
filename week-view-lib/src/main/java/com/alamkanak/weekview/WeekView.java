...
public class WeekView extends View {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(mHeaderColumnWidth, mHeaderHeight + mHeaderRowPadding + mHeaderMarginBottom + mTimeTextHeight / 2, getWidth(), getHeight(), Region.Op.INTERSECT);
        ...
        canvas.clipRect(0, 0, getWidth(), mHeaderHeight + mHeaderRowPadding * 2, Region.Op.INTERSECT);
